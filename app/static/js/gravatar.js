// Gravatar helper — works over plain HTTP (no crypto.subtle / secure-context
// requirement). Uses a self-contained MD5, which is Gravatar's hash algorithm.
function md5(string) {
...
function gravatarUrl(email) {
    ...
    return 'https://www.gravatar.com/avatar/' + md5(clean) + '?d=identicon&s=96';
}
